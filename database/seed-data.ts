...
type ValidCategories = "clothing" | "accessories";
...
export const seedData: SeedData = {
  products: [
    ...
    },
    {
      ...
      images: ["1740413-00-A_0_2000.jpg", "1740413-00-A_1.jpg"],
      inStock: 11,
      price: 38,
      sizes: ["XS", "S", "M", "L", "XL", "XXL"],
      slug: "cybertruck_graffiti_cuffed_beanie",
      type: "hats",
      tags: ["hats"],
      category: "accessories",
    ...
    {
      description:
        "The Cybertruck Graffiti Trucker Hat is a modern update on the traditional trucker hat style. The lightweight stretch weave exterior and peached inner face offers a stylish yet comfortable fit with a flexible single-piece construction ideal for any head shape. The dual face soft shell material adds UV protection with our signature 3D Cybertruck graffiti logo featured on the front and an adjustable snapback closure on the back. The visor is fully made from recycled plastic bottles. 97% Polyester, 3% Elastane.",
      images: ["1657914-00-A_0_2000.jpg", "1657914-00-A_1.jpg"],
      inStock: 8,
      price: 40,
      sizes: ["XS", "S", "M", "L", "XL", "XXL"],
      slug: "cybertruck_graffiti_trucker_hat",
      type: "hats",
      tags: ["hats"],
      category: "accessories",
      title: "Cybertruck Graffiti Trucker Hat",
      gender: "unisex",
    },
    {
      description:
